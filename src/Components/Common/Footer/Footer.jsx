import "./Footer.scss";
import logo from "../../../assets/Logo/EzDoc-Logo-White.png";
    ...
    return (
        <footer className="footer">
            <div className="footer_content">
                ...
                <div className="footer_col footer_col_contact">
                    ...
                    <div className="contact_details">
                        ...
                        <p>WhatsApp: <a href="https://wa.me/971526120440" target="_blank" rel="noopener noreferrer">Click to Chat</a></p>
            ...
            <div className="footer_copyright">
                ...
                <p className="copyright_text">© 2025 EZDoc Healthcare LLC. All Rights Reserved.</p>
            </div>
        </footer>
    );
}