...
const OPTION_LABELS = {
    "doctor-visits": "Doctor Home Visits",
    "nurse-visits": "Nurse Home Visits",
    "lab-tests": "Lab Tests at Home",
    "iv-drips": "Sick Day IV Drips",
};

const SERVICES = [
    { id: "doctor-visits", label: "Doctor Home Visits", description: "DHA-licensed doctors at your doorstep" },
    { id: "nurse-visits", label: "Nurse Home Visits", description: "Professional nursing care at home" },
    { id: "lab-tests", label: "Lab Tests at Home", description: "Skip clinic queues, get tests at home" },
    { id: "iv-drips", label: "Sick Day IV Drips", description: "Rapid recovery with IV therapy" },
];
    ...
    useEffect(() => {
        if (messages.length === 0 && !hasInitialized.current) {
            ...
            setMessages([
                {
                    type: "bot",
                    content: "Hello! 👋 Welcome to City Doctor. I'm here to help you book medical services at your home, hotel, or office. How can I assist you today?",
                    timestamp: new Date(),
                },
            ]);
    ...
    const handleNameSubmit = (e) => {
        ...
        setTimeout(() => {
            addAcknowledgment(`Nice to meet you, ${userName}! 😊`, () => {
                ...
                setTimeout(() => {
                    addBotMessageWithTyping("Which medical service are you interested in?", null, true);
    ...
    const handleServiceSelect = (serviceId) => {
        ...
        setTimeout(() => {
            addAcknowledgment(randomAck, () => {
                ...
                setTimeout(() => {
                    addBotMessageWithTyping("Have you used home medical services before?", null, true);
        ...
        setTimeout(() => {
            if (interested) {
                addAcknowledgment("That's wonderful! 😊", () => {
                    setTimeout(() => {
                        const phoneMessage = "📞 Please provide your phone number so our medical team can contact you and assist with booking your service.";
                    ...
                    addBotMessageWithTyping(
                        <div className="chatbot-success-message">
                            ...
                            <div className="contact-info">
                                ...
                                <a href="tel:+971526120440" className="phone-link">
                                    +971 52 612 0440
                                </a>
                            </div>
                        </div>,
