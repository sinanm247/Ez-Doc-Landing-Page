...
import mobileBannerImage from "../../../assets/Banners/Banner-2.png";
    ...
    <>
      <div className="home-hero">
        ...
        <div className="hero-content">
          <h1 className="hero-title">{!isMobile ? "Simple Home Care for Everyday Illnesses" : "Doctor at Your Doorstep in 30 Mins"}</h1>
          ...
          <div className="hero-buttons">
            <a href="https://wa.me/971526120440" className="btn white-btn" target="_blank" rel="noopener noreferrer">
              <FaWhatsapp className="btn-icon" />
              WhatsApp
            </a>
            <a href="tel:+971526120440" target="_blank" rel="noopener noreferrer" className="btn secondary-btn">
      ...
      <div className="hero-stats-mobile">
        <div className="stat-button primary-btn">
          <div className="stat-value">50K+</div>
